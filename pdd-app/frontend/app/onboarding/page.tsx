...
export default function OnboardingPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0F172A] flex flex-col p-8 relative overflow-hidden">
        ...
        <div className="max-w-md w-full space-y-12 relative z-10">
            ...
            >
                ...
                <div className="text-white">
                    <React.Fragment>
                    {React.createElement(steps[step].icon, { className: "h-10 w-10" })}
                    </React.Fragment>
                </div>
                </div>

                <div className="space-y-4">
                <h1 className="text-4xl font-black tracking-tight text-slate-900 dark:text-white uppercase">{steps[step].title}</h1>
            ...
            >
                <span>{step === steps.length - 1 ? "Initialize Workstation" : "Next Protocol"}</span>
