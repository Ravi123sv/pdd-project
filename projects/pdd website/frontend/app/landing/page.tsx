        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
             ...
             <div>
                ...
                <ul className="space-y-4">
                   <li><a href="#" className="text-xs font-bold text-slate-400 hover:text-primary">Privacy Protocol</a></li>
                   <li><a href="#" className="text-xs font-bold text-slate-400 hover:text-primary">License Terms</a></li>
                   <li><a href="#" className="text-xs font-bold text-slate-400 hover:text-primary">HIPAA Compliance</a></li>
                </ul>
             </div>
          </div>
